...
# $VIRTUAL_ENV/lib/python2.x/site-packages/django
...
ADMINS = (
    ("Tatsuo Ikeda", "jp.ne.co.jp@gmail.com"),
)

MANAGERS = ADMINS

# mail
EMAIL_SUBJECT_PREFIX = "[appserver-development][%s]" % socket.gethostname()
...
SECRET_KEY = "#8r=+ak47^fvtzu%&amp;0k-k9c#j4(eytfcu##^=q0#t81@3r+0kb"
